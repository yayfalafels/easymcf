...
- **data model** [010-data-model.md](010-data-model.md): the entities the data-model silo below operates on: `role`, `track`, `search_profile`, `cv`, `post`, `post_track`, `lead`, `lead_event`, `application`, `run_log`, `session`.
