...
Subtask `09.13.15` (data model and seed data) is implemented and validated: schema version 6 and the regenerated seed match the design by direct database inspection, and the closing command reports 121 passed on a version 6 scratch database. The feature subtasks `09.13.01` to `09.13.07` from the remaining edit locations (for the files that `09.13.15` touched, take the tested content of the edit location block), then the manual pass (`09.13.16`). `data/easymcf.db` is reset at version 6 with the new seed. `data/browse-09.db` (the scratch database for manual browsing) is still at version 5, so rebuild it before browsing. Manual validation of `09.TC.34` closes task 09.11.
...
| 09.13 | 13  | open    | lead pipeline and offer enh |
| 09.IS | 14  | pending | validate                    |
...
| 09.IS.39 | 39  | open   | leads - batch apply and drop from toapply with row checkboxes                 |
| 09.IS.40 | 40  | open   | leads - compact table rows for toapply and applied                            |
| 09.IS.41 | 41  | open   | leads - sort by days remaining, and by last contact from callback             |
| 09.IS.42 | 42  | open   | leads - latest note and last contact on cards from callback                   |
| 09.IS.43 | 43  | open   | leads - expected salary on the lead and its card                              |
| 09.IS.44 | 44  | closed | search profile - one profile per track, already enforced                      |
| 09.IS.45 | 45  | open   | offers - offers table, api, page, and a gated offer stage                     |
| 09.IS.46 | 46  | open   | leads - drop the prospect stage, leads start at toapply, dropped reason       |
...
| 09.IS.51 | 51  | open   | leads - re-assign the track of a lead from lead detail                        |
...
_09.IS.39 (open) leads - batch apply and drop from toapply with row checkboxes_
...
_09.IS.40 (open) leads - compact table rows for toapply and applied_
...
_09.IS.41 (open) leads - sort by days remaining, and by last contact from callback_
...
_09.IS.42 (open) leads - latest note and last contact on cards from callback_
...
_09.IS.43 (open) leads - expected salary on the lead and its card_
...
_09.IS.45 (open) offers - offers table, api, page, and a gated offer stage_
...
_09.IS.46 (open) leads - drop the prospect stage, leads start at toapply, dropped reason_
...
_09.IS.51 (open) leads - re-assign the track of a lead from lead detail_
...
### 09.13 (open) job leads enhancements
...
| 09.13.01 | 09  | open    | drop prospect, toapply is the entry and apply queue | 09.IS.46 |
| 09.13.02 | 10  | pending | batch apply and drop from toapply with checkboxes   | 09.IS.39 |
| 09.13.03 | 11  | pending | compact table rows for toapply and applied          | 09.IS.40 |
| 09.13.04 | 12  | pending | sort by days remaining, and by last contact         | 09.IS.41 |
| 09.13.05 | 13  | pending | latest note and last contact on active-stage cards  | 09.IS.42 |
| 09.13.06 | 14  | pending | expected salary on the lead and its card            | 09.IS.43 |
| 09.13.07 | 15  | pending | offers table, api, page, and a gated offer stage    | 09.IS.45 |
| 09.13.17 | 16  | pending | re-assign the track from lead detail                | 09.IS.51 |
| 09.13.16 | 17  | pending | manual validation                                   | -------- |
