...
-- synthetic run-log coverage
INSERT INTO run_log (id, run_type, user_id, track_id, started_at, ended_at, status, outcome_counts, error_detail, trigger_source) VALUES (3, 'apply', 1, NULL, '2026-09-21 09:00:00', '2026-09-21 09:03:00', 'success', '{"applied": 1}', NULL, 'manual');
-- synthetic run-log coverage
INSERT INTO run_log (id, run_type, user_id, track_id, started_at, ended_at, status, outcome_counts, error_detail, trigger_source) VALUES (4, 'apply', 1, NULL, '2026-09-21 09:04:00', '2026-09-21 09:05:00', 'failed', '{"failed": 1}', 'synthetic failure fixture', 'manual');
-- synthetic run-log coverage
